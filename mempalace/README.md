...
| `normalize.py` | Converts chat exports (Claude Code JSONL, Codex CLI JSONL, Gemini CLI JSONL, Pi JSONL, Kimi Code JSONL, Claude.ai JSON, ChatGPT JSON, Slack JSON, plain text) to standard transcript format |
