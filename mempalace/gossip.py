...
EXAMPLE_GOSSIP_CONFIG: dict[str, Any] = {
    ...
    "chatter_nodes": [
        {
            "id": "chatter_alpha_tech",
            "name": "Chatter Alpha Tech",
            "wing": "alpha",
            "hall": "technical",
            "role": "technical_gossip",
            "specialties": ["contracts", "backend", "defi", "trading"],
            "rooms": ["contracts"],
            "gossip_radius": ["alpha", "gamma"],
            "chatter_level": "high",
