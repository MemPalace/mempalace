...
2. For automatic background saves and session-start memory recall, also run `mempalace/hooks/cursor/install.sh --scope user` from a cloned MemPalace repo. See `website/guide/cursor-hooks.md` for the walkthrough.
