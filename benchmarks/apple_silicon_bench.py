...
def main():
    ...
    print(f"\n{'=' * 70}")
    print("  Apple Silicon Embedding Benchmark")
    print(f"{'=' * 70}")
    ...
    for name, runner in backends:
        ...
        try:
            ...
            if "skipped" in r:
                ...
                print(f"mean {r['mean']:.2f}s  ({rate:.0f} chunks/s)  std {r['std']:.2f}")
        except Exception as e:
    ...
    print(f"{'=' * 70}\n")
    print("| Backend | Mean (s) | Rate (chunks/s) | vs baseline |")
    print("|---|---|---|---|")
    ...
    for name, r in results.items():
        ...
        if baseline:
            ...
            print(f"| {name} | {r['mean']:.2f} | {rate:.0f} | {speedup:.2f}x |")
        else:
